...
var require_quill_better_table = __commonJS({
  "node_modules/quill-better-table/dist/quill-better-table.js"(exports, module) {
    (function webpackUniversalModuleDefinition(root, factory) {
      if (typeof exports === "object" && typeof module === "object") module.exports = factory((init_quill(), __toCommonJS(quill_exports)));
      else if (typeof define === "function" && define.amd) define(["quill"], factory);
      else if (typeof exports === "object") exports["quillBetterTable"] = factory((init_quill(), __toCommonJS(quill_exports)));
              ...
              while (queue2.length > 0) {
                ...
                for (var i2 = 0; i2 < module2.parents.length; i2++) {
                  ...
                  if (parent.hot._acceptedDependencies[moduleId2]) {
                    if (!outdatedDependencies2[parentId]) outdatedDependencies2[parentId] = [];
